...
export default class Register extends Component {
    ...
    while (1) {
      ...
      if (typeof input["email"] !== "undefined") {
        ...
        if (!pattern.test(input["email"])) {
          isValid = false;
          errors["email"] =
            'Please enter valid email address (like "v@gmail.com")';
        }
      }
      break;
    }
  ...
  onRequestSmsCode = (ev) => {
    ...
    if (
      this.state.input.phone_for_gmail === undefined ||
  ...
  handleInputChange = (event) => {
    ...
    if (event.target.name === "password") {
      ...
      if (
        this.state.input.phone_for_gmail &&
        this.state.input.sms_code_for_gmail
      ) {
        this.showMessageForGmailPhone("");
        this.setState({ loading: true });
        verifySmsCode(
          ...
          (resp) => {
            ...
            if (
              ...
              me.showMessageForGmailPhone(
                "Success to phone verfication",
                NOTIFY_INFORMATION
              );
            } else {
              me.showMessageForGmailPhone(
                resp.message ? resp.message : "Failed to phone verfication"
              );
            }
          }
        );
  ...
  responseGoogle = (response) => {
    ...
    if (
      this.state.phoneId === undefined ||
      this.state.phoneId === null ||
      this.state.phoneId === ""
    ) {
      this.showMessageForGmailPhone(
        "Please verify with your phone and try again."
      );
      return;
    }
      ...
      <div>
        ...
        <div className="main-container py-20 px-10 lg:px-80">
          <div className="home-card w-full">
            <p className="text-center main-font font-30 main-color-blue mb-10 capitalize">
            ...
            <div className="flex signup-form">
                ...
                <div className="signup-content_box w-full relative">
                  <div className="mb-10">
                    ...
                    >
                      ...
                      {this.state.loading && (
                        <span>
                          Sending({this.state.loading_sms_verify_interval})
                        </span>
                      )}
                  ...
                  <input
                    ...
                    autoComplete="off"
                  />
                  <span className="block help-block main-font text-red-400 mb-10 font-16 visible">
                    {this.state.warning.phone_for_gmail}
                  </span>
                  <span className="block help-block main-font text-green-400 mb-10 font-16 visible">
                    {this.state.message.phone_for_gmail}
                  </span>
                  <GoogleLogin
              ...
              <div className="middle-line-container flex items-center justify-between">
                ...
                <p className="main-font main-color font-16 px-5 divide-text">
                  OR
                </p>
                <hr className="middle-line" />
              </div>
              <div className="w-1/2 signup-content border-l border-gray-300  md:pl-20 md:pr-10">
                ...
                <span className="help-block main-font text-red-400 font-16">
                  {this.state.errors.register_result}
                </span>
                <div className="text-black">
                  ...
                  <div className="mb-10 relative">
                    <input
                      ...
                      autoComplete="off"
                    />
                    <span className="help-block main-font text-red-400 font-14">
                  ...
                  <div className="mb-10">
                    ...
                    />
                    <span className="help-block main-font text-red-400 font-14">
                      {this.state.errors.phone_for_email}
                    </span>
                  </div>
                  <div className="mb-10">
                ...
                <div className="main-font main-color font-16 m-8 capitalize">
                  ...
                  <Link
                    className="border-b border-gray-400 main-color-blue ml-5"
                    to="/login"
                  >
                    Login here
                  </Link>
