...
export default class Login extends Component {
  constructor(props) {
    ...
    if (
      ...
      props.location.state.email !== undefined &&
  ...
  _onSubmit() {
    ...
    if (this.state.password.trim() === "") {
      this.setState({
        errors: { password: "Please input password for your Email" },
      });
      return;
    }
      ...
      <div>
        ...
        <div className="main-container p-20">
          <div className="home-card mx-auto auth-form">
            ...
            <div>
              <span
                id="warning-message-box-for-google-login-failure"
                className="block help-block main-font text-red-400 mt-5 mb-5 font-16"
              >
                {this.state.warning.google_login}
              </span>
              <Link
                id="link-to-signup-popup"
                className="border-b border-gray-400 main-color-blue ml-5"
                hidden={this.state.hide_link_to_signup}
                to="/register"
              >
                Sign Up Here
              </Link>
            ...
            <div className="flex items-center rememberme-container">
              ...
              <label
                htmlFor="rememberMe"
                className="main-font main-color ml-3 font-14"
              >
                Remember me
              </label>
            </div>
