...
const WalletPage = (props) => {
  ...
  const [user_level, setUserLevel] = useState(USER_ACCOUNT_UNLOCKED);
    ...
    switch (user_level) {
      ...
      case NEW_USER_1:
        return (
          <WalletActivatePage
            userToken={user_token}
            onRegisteredAccount={onRegisteredAccount}
            {...props}
          />
        );
      ...
      case USER_ACCOUNT_UNLOCKED:
        return (
          <WalletMainPage
            userToken={user_token}
            onLockedAccount={onLockedAccount}
            {...props}
          />
        );
      case PASSCODE_RESET:
