  ...
  render() {
    return (
      <Modal
        ...
        toggler={() => this.setShowModal(false)}
      >
        <ModalHeader toggler={() => this.setShowModal(false)}>
          <div className="dialog-title">Passcode confirm</div>
        </ModalHeader>
        <ModalBody>
          ...
          <p className="account-balance-box main-font text-red-400 mb-100 font-16">
            {this.state.error}
          </p>
          <p className="help-block main-font text-green-400 font-16">
            {this.state.info}
          </p>
        </ModalBody>
        <ModalFooter>
